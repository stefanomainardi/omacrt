...
| `docs/` | The 15 kHz study, [the compositor](docs/flyback.md) and [how it sits beside the others](docs/comparison.md), [how the mark was drawn](docs/identity.md), what is on the tube screen by screen, what Omarchy lends it, [the same without Omarchy](docs/hyprland.md), hardware notes, systems and video policy, controllers, CLI, troubleshooting |
