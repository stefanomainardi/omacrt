...
describes. The longest field measured 291.0 lines, and 291 is the number the
rate walk of the day before put this set's cliff at, arrived at for an
unrelated reason. One field in a thousand is stretched to exactly where this
television gives up.
