...
Every number in this project was taken on one set in one room. That is the
honest limit of all of it, and one row is not a survey.
...
| --- | --- | --- | --- | --- |
| Bang & Olufsen BeoCenter 1, 1998 | RGB-Pi 2 over HDMI, RGB SCART | RX 7700/7800 XT, amdgpu | yes, 15.731 kHz, 240p and 288p | **55 Hz**, and it is a cliff: 15% shorter at 54 and no worse at 50 |
...
losing height is a property of the set, not of the software, and it is the one
number here that cannot be derived from anything else.
...
rather than shrinking further. That is a regulation dropping out rather than an
amplitude following a period, which is why the configuration holds at 55 with
no margin below it. Six seconds back at 60 Hz and the picture was still 3.7%
...
checked rather than trusted. Read it first.
